...
$.fn.KinSlideshow = function(settings){
	  ...
	  settings = jQuery.extend({
		   ...
		   isHasTitleFont:true,
		   titleFont:{TitleFont_size:16,TitleFont_color:"#FFFFFF",TitleFont_family:"Verdana",TitleFont_weight:"bold"},
		   isHasBtn:true,
	 ...
	 function KSS_setTitleBar(){
		...
		$(ksbs+" .KSS_titleBar").css({height:getTitleBar_Height,width:580,position:"absolute",bottom:0,left:0})
	 ...
	 function KSS_setTitleFont(){
		 if(settings.isHasTitleFont){
			$(ksthis).append("<div class='KSS_titleBox'><h2 class='title' style='margin:10px 0px 0px 15px; padding:0;'></h2></div>");
	 ...
	 function KSS_setBtn(){
		 ...
		 if(settings.isHasBtn && KSS_imgaeLength >= 2){
			 ...
			 KSS_btnList = "<ul id='btnlistID' style='margin:-8px;padding:0; overflow:hidden'>"+KSS_btnList+"</ul>";
