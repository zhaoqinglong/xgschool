<%@ Page Title="" Language="C#" MasterPageFile="~/commercial/show.Master" AutoEventWireup="true" CodeBehind="classes.aspx.cs" Inherits="XGSchool.commercial.classes" %>
...
<div class="columns1">
您现在位置：<span class="myspan"><a href="#">首页</a></span>/<span class="myspan"><a href="#">商演培训</a></span>/<span class="myspan">课程设置</span>
</div>
<div class="columns2">
	<div class="columns2-left-art boxborder myfloat">
        ...
        <div class="border-no"><a href="classes.aspx?colsId=6" class="newactive-show">课程设置</a></div>
    </div>
