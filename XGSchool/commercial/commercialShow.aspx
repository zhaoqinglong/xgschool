<%@ Page Title="" Language="C#" MasterPageFile="~/commercial/show.Master" AutoEventWireup="true" CodeBehind="commercialShow.aspx.cs" Inherits="XGSchool.commercial.commercialShow" %>
...
<div class="columns1">
您现在位置：<span class="myspan"><a href="#">首页</a></span>/<span class="myspan"><a href="#">商演培训</a></span>/<span class="myspan">学院简介</span>
</div>
<div class="columns2">
	<div class="columns2-left-art boxborder myfloat">
    	<div class=""><a href="commercialShow.aspx?colsId=2" class="newactive-show">学院简介</a></div>
